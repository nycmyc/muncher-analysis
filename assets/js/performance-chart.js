document.addEventListener('DOMContentLoaded', function() {
  ...
  efficiencyCanvas.style.marginTop = '20px';
  chartContainer.appendChild(efficiencyCanvas);
  ...
  const efficiencyChart = new Chart(efficiencyCanvas, {
    type: 'line',
    data: efficiencyData,
    options: {
      responsive: true,
      ...
      plugins: {
        title: {
          display: true,
          text: 'System Efficiency Improvement Over Time',
          font: {
            size: 14,
            weight: 'bold'
          }
